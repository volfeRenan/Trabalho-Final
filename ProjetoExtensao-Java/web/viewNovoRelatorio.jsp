...
<html>
    <head>
        ...
        <title>Projetos de Extensão - Cadastro de Relatório</title>
                ...
                <header class="w3-black" id="home">
                    <div class=" w3-black">
                        <div class="titulo w3-black w3-center">
                            <a class="w3-button" href="viewDetalheProjeto.jsp?idProj=<%=request.getParameter("idProj")%>" style="float: left"><img src="img/icon/voltar.png"/></a>                        
                            <h4><b>Novo Relatório</b></h4>
                        </div>
                    </div>
                </header>
                <!--Fim titulo da página-->
                    ...
                    <div class="w3-row">
                        ...
                        <div class="gridForm w3-col s6 w3-card" style="background-color: #EEEBFF;">
                            <form action="salvarRelatorio.jsp" method="post" style="margin-left: 20px;">
                                <p>
                                    <span>Cod. do Projeto</span>
                                    <input class="w3-input w3-border-bottom" type="text" name="txtIdFk" Readonly value="<%=request.getParameter("idProj")%>" style="width: 100px"/>
                                </p>
                                <p>
                                    <span><b>*Data</b></span>
                                    <input class="w3-input w3-border-bottom" type="date" name="txtData" style="width: 200px"/>
                                </p>
                                <p>
                                    <span><b>*Atividades Realizadas</b></span>
                                    <textarea class="w3-input w3-border-bottom" type="text" name="txtAtividades" style="width: 350px; height: 100px"></textarea>
                                </p>
