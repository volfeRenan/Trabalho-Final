...
<html>
    <head>
        ...
        <title>Projetos de Extensão - Excluir Relatório</title>
                ...
                <!--Fim titulo da página-->
                    ...
                    <div class="w3-row">
                        ...
                        <div class="gridForm w3-col s6 w3-card" style="background-color: #EEEBFF;">
                            <form action="excluirRelatorio.jsp?fkProj=<%=request.getParameter("fkProj")%>" method="post" style="margin-left: 20px; padding-bottom: 20px">
                                <p>
